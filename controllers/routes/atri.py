...
class Atri:
	def __init__(self, state: Any):
		...
		self.MainContainer = state["MainContainer"]
		self.Hero1Con = state["Hero1Con"]
		self.Flex21 = state["Flex21"]
		self.Flex22 = state["Flex22"]
		self.NavbarCon = state["NavbarCon"]
		self.Flex12 = state["Flex12"]
		self.TrustedByCon = state["TrustedByCon"]
		...
		self.ProjectHeader = state["ProjectHeader"]
		self.ProjectTitle = state["ProjectTitle"]
		self.Heading = state["Heading"]
		self.Flex53 = state["Flex53"]
		self.Flex54 = state["Flex54"]
		self.ProjectDetails = state["ProjectDetails"]
		...
		self.BlogsCon = state["BlogsCon"]
		self.BlogTitle = state["BlogTitle"]
		self.BlogDetail = state["BlogDetail"]
		...
		self.ProductDesigner = state["ProductDesigner"]
		self.ProductTop = state["ProductTop"]
		self.Flex138 = state["Flex138"]
		self.Flex139 = state["Flex139"]
		self.ImageCon = state["ImageCon"]
		self.Flex148 = state["Flex148"]
		self.BlackBG = state["BlackBG"]
		self.FAQCON = state["FAQCON"]
		self.FAQHEAD = state["FAQHEAD"]
		self.AllQues = state["AllQues"]
		self.QR1 = state["QR1"]
		...
		self.Foothead = state["Foothead"]
		self.AllLinks = state["AllLinks"]
		self.LR = state["LR"]
		self.RR = state["RR"]
		self.R1 = state["R1"]
		self.Flex200 = state["Flex200"]
		self.Flex201 = state["Flex201"]
		self.Testomonial = state["Testomonial"]
		self.TestHead = state["TestHead"]
		self.TCon = state["TCon"]
		self.Flex205 = state["Flex205"]
		self.TRR = state["TRR"]
		self.TRRBottom = state["TRRBottom"]
		self.Flex208 = state["Flex208"]
		self.Flex209 = state["Flex209"]
		self.EduWork = state["EduWork"]
		self.EduCon = state["EduCon"]
		self.Head = state["Head"]
		self.EduDetails = state["EduDetails"]
		self.EduDetail = state["EduDetail"]
		self.UniName = state["UniName"]
		self.Course = state["Course"]
		...
		self.Icon27 = state["Icon27"]
		self.Icon28 = state["Icon28"]
		...
		self.TextBox272 = state["TextBox272"]
		self.TEXTBOX273 = state["TEXTBOX273"]
		self.TextBox274 = state["TextBox274"]
		self.TLR = state["TLR"]
		self.Icon24 = state["Icon24"]
		self.TextBox275 = state["TextBox275"]
		self.TextBox276 = state["TextBox276"]
		self.TextBox277 = state["TextBox277"]
		self.Icon25 = state["Icon25"]
		self.Icon26 = state["Icon26"]
		self.TextBox278 = state["TextBox278"]
		self.TextBox279 = state["TextBox279"]
		self.Icon30 = state["Icon30"]
		self.TextBox280 = state["TextBox280"]
		self.TextBox281 = state["TextBox281"]
		self.TextBox282 = state["TextBox282"]
		self.TextBox283 = state["TextBox283"]
		self.Icon31 = state["Icon31"]
		self.TextBox284 = state["TextBox284"]
		self.TextBox288 = state["TextBox288"]
		self.Icon33 = state["Icon33"]
		self.TextBox289 = state["TextBox289"]
		self.TextBox290 = state["TextBox290"]
		self.Icon39 = state["Icon39"]
		self.TextBox303 = state["TextBox303"]
		self.TextBox304 = state["TextBox304"]
		self.Icon38 = state["Icon38"]
		self.TextBox305 = state["TextBox305"]
		self.Icon41 = state["Icon41"]
		self.TextBox307 = state["TextBox307"]
		self.Icon40 = state["Icon40"]
		self.TextBox308 = state["TextBox308"]
		self.TextBox309 = state["TextBox309"]
		self.Icon43 = state["Icon43"]
		self.TextBox310 = state["TextBox310"]
		self.Icon42 = state["Icon42"]
	...
	def MainContainer(self):
		self._getter_access_tracker["MainContainer"] = {}
		return self._MainContainer
	@MainContainer.setter
	def MainContainer(self, new_state):
		self._setter_access_tracker["MainContainer"] = {}
		global default_state
		self._MainContainer = Flex(new_state, default_state["MainContainer"])

	@property
	def Hero1Con(self):
		self._getter_access_tracker["Hero1Con"] = {}
		return self._Hero1Con
	@Hero1Con.setter
	def Hero1Con(self, new_state):
		self._setter_access_tracker["Hero1Con"] = {}
		global default_state
		self._Hero1Con = Flex(new_state, default_state["Hero1Con"])
	...
	@property
	def NavbarCon(self):
		self._getter_access_tracker["NavbarCon"] = {}
		return self._NavbarCon
	@NavbarCon.setter
	def NavbarCon(self, new_state):
		self._setter_access_tracker["NavbarCon"] = {}
		global default_state
		self._NavbarCon = Flex(new_state, default_state["NavbarCon"])
	...
	@property
	def TrustedByCon(self):
		self._getter_access_tracker["TrustedByCon"] = {}
		return self._TrustedByCon
	@TrustedByCon.setter
	def TrustedByCon(self, new_state):
		self._setter_access_tracker["TrustedByCon"] = {}
		global default_state
		self._TrustedByCon = Flex(new_state, default_state["TrustedByCon"])
	...
	def Projects(self, new_state):
		...
		global default_state
		self._Projects = Flex(new_state, default_state["Projects"])

	@property
	def ProjectHeader(self):
		self._getter_access_tracker["ProjectHeader"] = {}
		return self._ProjectHeader
	@ProjectHeader.setter
	def ProjectHeader(self, new_state):
		self._setter_access_tracker["ProjectHeader"] = {}
		global default_state
		self._ProjectHeader = Flex(new_state, default_state["ProjectHeader"])

	@property
	def ProjectTitle(self):
		self._getter_access_tracker["ProjectTitle"] = {}
		return self._ProjectTitle
	@ProjectTitle.setter
	def ProjectTitle(self, new_state):
		self._setter_access_tracker["ProjectTitle"] = {}
		global default_state
		self._ProjectTitle = Flex(new_state, default_state["ProjectTitle"])
	...
	def Heading(self, new_state):
		...
		global default_state
		self._Heading = Flex(new_state, default_state["Heading"])
	...
	def ProjectDetails(self):
		self._getter_access_tracker["ProjectDetails"] = {}
		return self._ProjectDetails
	@ProjectDetails.setter
	def ProjectDetails(self, new_state):
		self._setter_access_tracker["ProjectDetails"] = {}
		global default_state
		self._ProjectDetails = Flex(new_state, default_state["ProjectDetails"])
	...
	@property
	def BlogsCon(self):
		self._getter_access_tracker["BlogsCon"] = {}
		return self._BlogsCon
	@BlogsCon.setter
	def BlogsCon(self, new_state):
		self._setter_access_tracker["BlogsCon"] = {}
		global default_state
		self._BlogsCon = Flex(new_state, default_state["BlogsCon"])

	@property
	def BlogTitle(self):
		self._getter_access_tracker["BlogTitle"] = {}
		return self._BlogTitle
	@BlogTitle.setter
	def BlogTitle(self, new_state):
		self._setter_access_tracker["BlogTitle"] = {}
		global default_state
		self._BlogTitle = Flex(new_state, default_state["BlogTitle"])

	@property
	def BlogDetail(self):
		self._getter_access_tracker["BlogDetail"] = {}
		return self._BlogDetail
	@BlogDetail.setter
	def BlogDetail(self, new_state):
		self._setter_access_tracker["BlogDetail"] = {}
		global default_state
		self._BlogDetail = Flex(new_state, default_state["BlogDetail"])
	...
	@property
	def ProductDesigner(self):
		self._getter_access_tracker["ProductDesigner"] = {}
		return self._ProductDesigner
	@ProductDesigner.setter
	def ProductDesigner(self, new_state):
		self._setter_access_tracker["ProductDesigner"] = {}
		global default_state
		self._ProductDesigner = Flex(new_state, default_state["ProductDesigner"])

	@property
	def ProductTop(self):
		self._getter_access_tracker["ProductTop"] = {}
		return self._ProductTop
	@ProductTop.setter
	def ProductTop(self, new_state):
		self._setter_access_tracker["ProductTop"] = {}
		global default_state
		self._ProductTop = Flex(new_state, default_state["ProductTop"])
	...
	@property
	def ImageCon(self):
		self._getter_access_tracker["ImageCon"] = {}
		return self._ImageCon
	@ImageCon.setter
	def ImageCon(self, new_state):
		self._setter_access_tracker["ImageCon"] = {}
		global default_state
		self._ImageCon = Flex(new_state, default_state["ImageCon"])
	...
	@property
	def BlackBG(self):
		self._getter_access_tracker["BlackBG"] = {}
		return self._BlackBG
	@BlackBG.setter
	def BlackBG(self, new_state):
		self._setter_access_tracker["BlackBG"] = {}
		global default_state
		self._BlackBG = Flex(new_state, default_state["BlackBG"])

	@property
	def FAQCON(self):
		self._getter_access_tracker["FAQCON"] = {}
		return self._FAQCON
	@FAQCON.setter
	def FAQCON(self, new_state):
		self._setter_access_tracker["FAQCON"] = {}
		global default_state
		self._FAQCON = Flex(new_state, default_state["FAQCON"])

	@property
	def FAQHEAD(self):
		self._getter_access_tracker["FAQHEAD"] = {}
		return self._FAQHEAD
	@FAQHEAD.setter
	def FAQHEAD(self, new_state):
		self._setter_access_tracker["FAQHEAD"] = {}
		global default_state
		self._FAQHEAD = Flex(new_state, default_state["FAQHEAD"])

	@property
	def AllQues(self):
		self._getter_access_tracker["AllQues"] = {}
		return self._AllQues
	@AllQues.setter
	def AllQues(self, new_state):
		self._setter_access_tracker["AllQues"] = {}
		global default_state
		self._AllQues = Flex(new_state, default_state["AllQues"])

	@property
	def QR1(self):
		self._getter_access_tracker["QR1"] = {}
		return self._QR1
	@QR1.setter
	def QR1(self, new_state):
		self._setter_access_tracker["QR1"] = {}
		global default_state
		self._QR1 = Flex(new_state, default_state["QR1"])
	...
	@property
	def QR2(self):
		self._getter_access_tracker["QR2"] = {}
		return self._QR2
	@QR2.setter
	def QR2(self, new_state):
		self._setter_access_tracker["QR2"] = {}
		global default_state
		self._QR2 = Flex(new_state, default_state["QR2"])
	...
	@property
	def Foothead(self):
		self._getter_access_tracker["Foothead"] = {}
		return self._Foothead
	@Foothead.setter
	def Foothead(self, new_state):
		self._setter_access_tracker["Foothead"] = {}
		global default_state
		self._Foothead = Flex(new_state, default_state["Foothead"])

	@property
	def AllLinks(self):
		self._getter_access_tracker["AllLinks"] = {}
		return self._AllLinks
	@AllLinks.setter
	def AllLinks(self, new_state):
		self._setter_access_tracker["AllLinks"] = {}
		global default_state
		self._AllLinks = Flex(new_state, default_state["AllLinks"])

	@property
	def LR(self):
		self._getter_access_tracker["LR"] = {}
		return self._LR
	@LR.setter
	def LR(self, new_state):
		self._setter_access_tracker["LR"] = {}
		global default_state
		self._LR = Flex(new_state, default_state["LR"])

	@property
	def RR(self):
		self._getter_access_tracker["RR"] = {}
		return self._RR
	@RR.setter
	def RR(self, new_state):
		self._setter_access_tracker["RR"] = {}
		global default_state
		self._RR = Flex(new_state, default_state["RR"])

	@property
	def R1(self):
		self._getter_access_tracker["R1"] = {}
		return self._R1
	@R1.setter
	def R1(self, new_state):
		self._setter_access_tracker["R1"] = {}
		global default_state
		self._R1 = Flex(new_state, default_state["R1"])
	...
	@property
	def Testomonial(self):
		self._getter_access_tracker["Testomonial"] = {}
		return self._Testomonial
	@Testomonial.setter
	def Testomonial(self, new_state):
		self._setter_access_tracker["Testomonial"] = {}
		global default_state
		self._Testomonial = Flex(new_state, default_state["Testomonial"])

	@property
	def TestHead(self):
		self._getter_access_tracker["TestHead"] = {}
		return self._TestHead
	@TestHead.setter
	def TestHead(self, new_state):
		self._setter_access_tracker["TestHead"] = {}
		global default_state
		self._TestHead = Flex(new_state, default_state["TestHead"])

	@property
	def TCon(self):
		self._getter_access_tracker["TCon"] = {}
		return self._TCon
	@TCon.setter
	def TCon(self, new_state):
		self._setter_access_tracker["TCon"] = {}
		global default_state
		self._TCon = Flex(new_state, default_state["TCon"])
	...
	@property
	def TRR(self):
		self._getter_access_tracker["TRR"] = {}
		return self._TRR
	@TRR.setter
	def TRR(self, new_state):
		self._setter_access_tracker["TRR"] = {}
		global default_state
		self._TRR = Flex(new_state, default_state["TRR"])

	@property
	def TRRBottom(self):
		self._getter_access_tracker["TRRBottom"] = {}
		return self._TRRBottom
	@TRRBottom.setter
	def TRRBottom(self, new_state):
		self._setter_access_tracker["TRRBottom"] = {}
		global default_state
		self._TRRBottom = Flex(new_state, default_state["TRRBottom"])
	...
	@property
	def EduWork(self):
		self._getter_access_tracker["EduWork"] = {}
		return self._EduWork
	@EduWork.setter
	def EduWork(self, new_state):
		self._setter_access_tracker["EduWork"] = {}
		global default_state
		self._EduWork = Flex(new_state, default_state["EduWork"])

	@property
	def EduCon(self):
		self._getter_access_tracker["EduCon"] = {}
		return self._EduCon
	@EduCon.setter
	def EduCon(self, new_state):
		self._setter_access_tracker["EduCon"] = {}
		global default_state
		self._EduCon = Flex(new_state, default_state["EduCon"])

	@property
	def Head(self):
		self._getter_access_tracker["Head"] = {}
		return self._Head
	@Head.setter
	def Head(self, new_state):
		self._setter_access_tracker["Head"] = {}
		global default_state
		self._Head = Flex(new_state, default_state["Head"])

	@property
	def EduDetails(self):
		self._getter_access_tracker["EduDetails"] = {}
		return self._EduDetails
	@EduDetails.setter
	def EduDetails(self, new_state):
		self._setter_access_tracker["EduDetails"] = {}
		global default_state
		self._EduDetails = Flex(new_state, default_state["EduDetails"])

	@property
	def EduDetail(self):
		self._getter_access_tracker["EduDetail"] = {}
		return self._EduDetail
	@EduDetail.setter
	def EduDetail(self, new_state):
		self._setter_access_tracker["EduDetail"] = {}
		global default_state
		self._EduDetail = Flex(new_state, default_state["EduDetail"])

	@property
	def UniName(self):
		self._getter_access_tracker["UniName"] = {}
		return self._UniName
	@UniName.setter
	def UniName(self, new_state):
		self._setter_access_tracker["UniName"] = {}
		global default_state
		self._UniName = Flex(new_state, default_state["UniName"])

	@property
	def Course(self):
		self._getter_access_tracker["Course"] = {}
		return self._Course
	@Course.setter
	def Course(self, new_state):
		self._setter_access_tracker["Course"] = {}
		global default_state
		self._Course = Flex(new_state, default_state["Course"])
	...
	@property
	def Icon27(self):
		self._getter_access_tracker["Icon27"] = {}
		return self._Icon27
	@Icon27.setter
	def Icon27(self, new_state):
		self._setter_access_tracker["Icon27"] = {}
		global default_state
		self._Icon27 = Icon(new_state, default_state["Icon27"])

	@property
	def Icon28(self):
		self._getter_access_tracker["Icon28"] = {}
		return self._Icon28
	@Icon28.setter
	def Icon28(self, new_state):
		self._setter_access_tracker["Icon28"] = {}
		global default_state
		self._Icon28 = Icon(new_state, default_state["Icon28"])
	...
	@property
	def Icon11(self):
		self._getter_access_tracker["Icon11"] = {}
		return self._Icon11
	@Icon11.setter
	def Icon11(self, new_state):
		self._setter_access_tracker["Icon11"] = {}
		global default_state
		self._Icon11 = Icon(new_state, default_state["Icon11"])
	...
	@property
	def Icon13(self):
		self._getter_access_tracker["Icon13"] = {}
		return self._Icon13
	@Icon13.setter
	def Icon13(self, new_state):
		self._setter_access_tracker["Icon13"] = {}
		global default_state
		self._Icon13 = Icon(new_state, default_state["Icon13"])
	...
	@property
	def Icon14(self):
		self._getter_access_tracker["Icon14"] = {}
		return self._Icon14
	@Icon14.setter
	def Icon14(self, new_state):
		self._setter_access_tracker["Icon14"] = {}
		global default_state
		self._Icon14 = Icon(new_state, default_state["Icon14"])

	@property
	def Icon15(self):
		self._getter_access_tracker["Icon15"] = {}
		return self._Icon15
	@Icon15.setter
	def Icon15(self, new_state):
		self._setter_access_tracker["Icon15"] = {}
		global default_state
		self._Icon15 = Icon(new_state, default_state["Icon15"])
	...
	@property
	def Icon21(self):
		self._getter_access_tracker["Icon21"] = {}
		return self._Icon21
	@Icon21.setter
	def Icon21(self, new_state):
		self._setter_access_tracker["Icon21"] = {}
		global default_state
		self._Icon21 = Icon(new_state, default_state["Icon21"])

	@property
	def Icon22(self):
		self._getter_access_tracker["Icon22"] = {}
		return self._Icon22
	@Icon22.setter
	def Icon22(self, new_state):
		self._setter_access_tracker["Icon22"] = {}
		global default_state
		self._Icon22 = Icon(new_state, default_state["Icon22"])
	...
	@property
	def Icon23(self):
		self._getter_access_tracker["Icon23"] = {}
		return self._Icon23
	@Icon23.setter
	def Icon23(self, new_state):
		self._setter_access_tracker["Icon23"] = {}
		global default_state
		self._Icon23 = Icon(new_state, default_state["Icon23"])
	...
	@property
	def Icon20(self):
		self._getter_access_tracker["Icon20"] = {}
		return self._Icon20
	@Icon20.setter
	def Icon20(self, new_state):
		self._setter_access_tracker["Icon20"] = {}
		global default_state
		self._Icon20 = Icon(new_state, default_state["Icon20"])

	@property
	def Link16(self):
		self._getter_access_tracker["Link16"] = {}
		return self._Link16
	@Link16.setter
	def Link16(self, new_state):
		self._setter_access_tracker["Link16"] = {}
		global default_state
		self._Link16 = Link(new_state, default_state["Link16"])
	...
	@property
	def TextBox255(self):
		self._getter_access_tracker["TextBox255"] = {}
		return self._TextBox255
	@TextBox255.setter
	def TextBox255(self, new_state):
		self._setter_access_tracker["TextBox255"] = {}
		global default_state
		self._TextBox255 = TextBox(new_state, default_state["TextBox255"])
	...
	@property
	def TextBox258(self):
		self._getter_access_tracker["TextBox258"] = {}
		return self._TextBox258
	@TextBox258.setter
	def TextBox258(self, new_state):
		self._setter_access_tracker["TextBox258"] = {}
		global default_state
		self._TextBox258 = TextBox(new_state, default_state["TextBox258"])

	@property
	def TextBox259(self):
		self._getter_access_tracker["TextBox259"] = {}
		return self._TextBox259
	@TextBox259.setter
	def TextBox259(self, new_state):
		self._setter_access_tracker["TextBox259"] = {}
		global default_state
		self._TextBox259 = TextBox(new_state, default_state["TextBox259"])
	...
	@property
	def TextBox272(self):
		self._getter_access_tracker["TextBox272"] = {}
		return self._TextBox272
	@TextBox272.setter
	def TextBox272(self, new_state):
		self._setter_access_tracker["TextBox272"] = {}
		global default_state
		self._TextBox272 = TextBox(new_state, default_state["TextBox272"])

	@property
	def TEXTBOX273(self):
		self._getter_access_tracker["TEXTBOX273"] = {}
		return self._TEXTBOX273
	@TEXTBOX273.setter
	def TEXTBOX273(self, new_state):
		self._setter_access_tracker["TEXTBOX273"] = {}
		global default_state
		self._TEXTBOX273 = TextBox(new_state, default_state["TEXTBOX273"])

	@property
	def TextBox274(self):
		self._getter_access_tracker["TextBox274"] = {}
		return self._TextBox274
	@TextBox274.setter
	def TextBox274(self, new_state):
		self._setter_access_tracker["TextBox274"] = {}
		global default_state
		self._TextBox274 = TextBox(new_state, default_state["TextBox274"])

	@property
	def TLR(self):
		self._getter_access_tracker["TLR"] = {}
		return self._TLR
	@TLR.setter
	def TLR(self, new_state):
		self._setter_access_tracker["TLR"] = {}
		global default_state
		self._TLR = Image(new_state, default_state["TLR"])

	@property
	def Icon24(self):
		self._getter_access_tracker["Icon24"] = {}
		return self._Icon24
	@Icon24.setter
	def Icon24(self, new_state):
		self._setter_access_tracker["Icon24"] = {}
		global default_state
		self._Icon24 = Icon(new_state, default_state["Icon24"])

	@property
	def TextBox275(self):
		self._getter_access_tracker["TextBox275"] = {}
		return self._TextBox275
	@TextBox275.setter
	def TextBox275(self, new_state):
		self._setter_access_tracker["TextBox275"] = {}
		global default_state
		self._TextBox275 = TextBox(new_state, default_state["TextBox275"])

	@property
	def TextBox276(self):
		self._getter_access_tracker["TextBox276"] = {}
		return self._TextBox276
	@TextBox276.setter
	def TextBox276(self, new_state):
		self._setter_access_tracker["TextBox276"] = {}
		global default_state
		self._TextBox276 = TextBox(new_state, default_state["TextBox276"])

	@property
	def TextBox277(self):
		self._getter_access_tracker["TextBox277"] = {}
		return self._TextBox277
	@TextBox277.setter
	def TextBox277(self, new_state):
		self._setter_access_tracker["TextBox277"] = {}
		global default_state
		self._TextBox277 = TextBox(new_state, default_state["TextBox277"])

	@property
	def Icon25(self):
		self._getter_access_tracker["Icon25"] = {}
		return self._Icon25
	@Icon25.setter
	def Icon25(self, new_state):
		self._setter_access_tracker["Icon25"] = {}
		global default_state
		self._Icon25 = Icon(new_state, default_state["Icon25"])

	@property
	def Icon26(self):
		self._getter_access_tracker["Icon26"] = {}
		return self._Icon26
	@Icon26.setter
	def Icon26(self, new_state):
		self._setter_access_tracker["Icon26"] = {}
		global default_state
		self._Icon26 = Icon(new_state, default_state["Icon26"])

	@property
	def TextBox278(self):
		self._getter_access_tracker["TextBox278"] = {}
		return self._TextBox278
	@TextBox278.setter
	def TextBox278(self, new_state):
		self._setter_access_tracker["TextBox278"] = {}
		global default_state
		self._TextBox278 = TextBox(new_state, default_state["TextBox278"])

	@property
	def TextBox279(self):
		self._getter_access_tracker["TextBox279"] = {}
		return self._TextBox279
	@TextBox279.setter
	def TextBox279(self, new_state):
		self._setter_access_tracker["TextBox279"] = {}
		global default_state
		self._TextBox279 = TextBox(new_state, default_state["TextBox279"])

	@property
	def Icon30(self):
		self._getter_access_tracker["Icon30"] = {}
		return self._Icon30
	@Icon30.setter
	def Icon30(self, new_state):
		self._setter_access_tracker["Icon30"] = {}
		global default_state
		self._Icon30 = Icon(new_state, default_state["Icon30"])

	@property
	def TextBox280(self):
		self._getter_access_tracker["TextBox280"] = {}
		return self._TextBox280
	@TextBox280.setter
	def TextBox280(self, new_state):
		self._setter_access_tracker["TextBox280"] = {}
		global default_state
		self._TextBox280 = TextBox(new_state, default_state["TextBox280"])

	@property
	def TextBox281(self):
		self._getter_access_tracker["TextBox281"] = {}
		return self._TextBox281
	@TextBox281.setter
	def TextBox281(self, new_state):
		self._setter_access_tracker["TextBox281"] = {}
		global default_state
		self._TextBox281 = TextBox(new_state, default_state["TextBox281"])

	@property
	def TextBox282(self):
		self._getter_access_tracker["TextBox282"] = {}
		return self._TextBox282
	@TextBox282.setter
	def TextBox282(self, new_state):
		self._setter_access_tracker["TextBox282"] = {}
		global default_state
		self._TextBox282 = TextBox(new_state, default_state["TextBox282"])

	@property
	def TextBox283(self):
		self._getter_access_tracker["TextBox283"] = {}
		return self._TextBox283
	@TextBox283.setter
	def TextBox283(self, new_state):
		self._setter_access_tracker["TextBox283"] = {}
		global default_state
		self._TextBox283 = TextBox(new_state, default_state["TextBox283"])

	@property
	def Icon31(self):
		self._getter_access_tracker["Icon31"] = {}
		return self._Icon31
	@Icon31.setter
	def Icon31(self, new_state):
		self._setter_access_tracker["Icon31"] = {}
		global default_state
		self._Icon31 = Icon(new_state, default_state["Icon31"])

	@property
	def TextBox284(self):
		self._getter_access_tracker["TextBox284"] = {}
		return self._TextBox284
	@TextBox284.setter
	def TextBox284(self, new_state):
		self._setter_access_tracker["TextBox284"] = {}
		global default_state
		self._TextBox284 = TextBox(new_state, default_state["TextBox284"])

	@property
	def TextBox288(self):
		self._getter_access_tracker["TextBox288"] = {}
		return self._TextBox288
	@TextBox288.setter
	def TextBox288(self, new_state):
		self._setter_access_tracker["TextBox288"] = {}
		global default_state
		self._TextBox288 = TextBox(new_state, default_state["TextBox288"])

	@property
	def Icon33(self):
		self._getter_access_tracker["Icon33"] = {}
		return self._Icon33
	@Icon33.setter
	def Icon33(self, new_state):
		self._setter_access_tracker["Icon33"] = {}
		global default_state
		self._Icon33 = Icon(new_state, default_state["Icon33"])

	@property
	def TextBox289(self):
		self._getter_access_tracker["TextBox289"] = {}
		return self._TextBox289
	@TextBox289.setter
	def TextBox289(self, new_state):
		self._setter_access_tracker["TextBox289"] = {}
		global default_state
		self._TextBox289 = TextBox(new_state, default_state["TextBox289"])

	@property
	def TextBox290(self):
		self._getter_access_tracker["TextBox290"] = {}
		return self._TextBox290
	@TextBox290.setter
	def TextBox290(self, new_state):
		self._setter_access_tracker["TextBox290"] = {}
		global default_state
		self._TextBox290 = TextBox(new_state, default_state["TextBox290"])

	@property
	def Icon39(self):
		self._getter_access_tracker["Icon39"] = {}
		return self._Icon39
	@Icon39.setter
	def Icon39(self, new_state):
		self._setter_access_tracker["Icon39"] = {}
		global default_state
		self._Icon39 = Icon(new_state, default_state["Icon39"])
	...
	@property
	def Icon38(self):
		self._getter_access_tracker["Icon38"] = {}
		return self._Icon38
	@Icon38.setter
	def Icon38(self, new_state):
		self._setter_access_tracker["Icon38"] = {}
		global default_state
		self._Icon38 = Icon(new_state, default_state["Icon38"])

	@property
	def TextBox305(self):
		self._getter_access_tracker["TextBox305"] = {}
		return self._TextBox305
	@TextBox305.setter
	def TextBox305(self, new_state):
		self._setter_access_tracker["TextBox305"] = {}
		global default_state
		self._TextBox305 = TextBox(new_state, default_state["TextBox305"])

	@property
	def Icon41(self):
		self._getter_access_tracker["Icon41"] = {}
		return self._Icon41
	@Icon41.setter
	def Icon41(self, new_state):
		self._setter_access_tracker["Icon41"] = {}
		global default_state
		self._Icon41 = Icon(new_state, default_state["Icon41"])
	...
	@property
	def Icon40(self):
		self._getter_access_tracker["Icon40"] = {}
		return self._Icon40
	@Icon40.setter
	def Icon40(self, new_state):
		self._setter_access_tracker["Icon40"] = {}
		global default_state
		self._Icon40 = Icon(new_state, default_state["Icon40"])
	...
	@property
	def Icon43(self):
		self._getter_access_tracker["Icon43"] = {}
		return self._Icon43
	@Icon43.setter
	def Icon43(self, new_state):
		self._setter_access_tracker["Icon43"] = {}
		global default_state
		self._Icon43 = Icon(new_state, default_state["Icon43"])
	...
	@property
	def Icon42(self):
		self._getter_access_tracker["Icon42"] = {}
		return self._Icon42
	@Icon42.setter
	def Icon42(self, new_state):
		self._setter_access_tracker["Icon42"] = {}
		global default_state
		self._Icon42 = Icon(new_state, default_state["Icon42"])
	...
	def _to_json_fields(self):
		return {
			...
			"Hero1Con": self._Hero1Con,
			"Flex21": self._Flex21,
			"Flex22": self._Flex22,
			"NavbarCon": self._NavbarCon,
			"Flex12": self._Flex12,
			"TrustedByCon": self._TrustedByCon,
			"Flex33": self._Flex33,
			...
			"ProjectHeader": self._ProjectHeader,
			"ProjectTitle": self._ProjectTitle,
			"Heading": self._Heading,
			"Flex53": self._Flex53,
			"Flex54": self._Flex54,
			"ProjectDetails": self._ProjectDetails,
			...
			"Blogs": self._Blogs,
			"BlogsCon": self._BlogsCon,
			"BlogTitle": self._BlogTitle,
			"BlogDetail": self._BlogDetail,
			"Flex87": self._Flex87,
			...
			"ProductDesigner": self._ProductDesigner,
			"ProductTop": self._ProductTop,
			"Flex138": self._Flex138,
			"Flex139": self._Flex139,
			"ImageCon": self._ImageCon,
			"Flex148": self._Flex148,
			"BlackBG": self._BlackBG,
			"FAQCON": self._FAQCON,
			"FAQHEAD": self._FAQHEAD,
			"AllQues": self._AllQues,
			"QR1": self._QR1,
			...
			"Footer": self._Footer,
			"Foothead": self._Foothead,
			"AllLinks": self._AllLinks,
			"LR": self._LR,
			"RR": self._RR,
			"R1": self._R1,
			"Flex200": self._Flex200,
			"Flex201": self._Flex201,
			"Testomonial": self._Testomonial,
			"TestHead": self._TestHead,
			"TCon": self._TCon,
			"Flex205": self._Flex205,
			"TRR": self._TRR,
			"TRRBottom": self._TRRBottom,
			"Flex208": self._Flex208,
			"Flex209": self._Flex209,
			"EduWork": self._EduWork,
			"EduCon": self._EduCon,
			"Head": self._Head,
			"EduDetails": self._EduDetails,
			"EduDetail": self._EduDetail,
			"UniName": self._UniName,
			"Course": self._Course,
			...
			"TextBox255": self._TextBox255,
			"TextBox256": self._TextBox256,
			"TextBox257": self._TextBox257,
			"TextBox258": self._TextBox258,
			"TextBox259": self._TextBox259,
			...
			"TextBox272": self._TextBox272,
			"TEXTBOX273": self._TEXTBOX273,
			"TextBox274": self._TextBox274,
			"TLR": self._TLR,
			"Icon24": self._Icon24,
			"TextBox275": self._TextBox275,
			"TextBox276": self._TextBox276,
			"TextBox277": self._TextBox277,
			"Icon25": self._Icon25,
			"Icon26": self._Icon26,
			"TextBox278": self._TextBox278,
			"TextBox279": self._TextBox279,
			"Icon30": self._Icon30,
			"TextBox280": self._TextBox280,
			"TextBox281": self._TextBox281,
			"TextBox282": self._TextBox282,
			"TextBox283": self._TextBox283,
			"Icon31": self._Icon31,
			"TextBox284": self._TextBox284,
			"TextBox288": self._TextBox288,
			"Icon33": self._Icon33,
			"TextBox289": self._TextBox289,
			"TextBox290": self._TextBox290,
			"Icon39": self._Icon39,
			"TextBox303": self._TextBox303,
			"TextBox304": self._TextBox304,
			"Icon38": self._Icon38,
			"TextBox305": self._TextBox305,
			"Icon41": self._Icon41,
